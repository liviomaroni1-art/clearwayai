...
const translations: Record<Language, Record<string, string>> = {
    de: {
      ...
      'nav.product': 'Produkt',
          ...
          'hero.cta': 'Kostenloses Strategiegespräch',
          ...
          'hero.guarantee': '15+ Leads im ersten Monat – oder wir arbeiten kostenlos weiter.',
          'hero.trustbar.leads': '15+ Leads',
          'hero.trustbar.leads.sub': 'oder kostenlos weiter',
          'hero.trustbar.time': '7–14 Tage',
          'hero.trustbar.time.sub': 'bis zum Live-Start',
          'hero.trustbar.roas': '4.2×',
          'hero.trustbar.roas.sub': 'Ø ROAS nach 60 Tagen',
          ...
          'cta.button': 'Kostenloses Strategiegespräch',
          'cta.note': 'Keine Verpflichtung – nur ein klarer Plan für Ihre Lead-Generierung.',

          // Footer
          'footer.tagline': 'KI-gestützte Lead-Generierung für Dienstleister.',
          ...
          'footer.cta': 'Kostenloses Strategiegespräch',
    ...
    en: {
      ...
      'nav.product': 'Product',
          ...
          'hero.guarantee': '15+ leads in your first month — or we keep working for free.',
          'hero.trustbar.leads': '15+ Leads',
          'hero.trustbar.leads.sub': 'or we work for free',
          'hero.trustbar.time': '7–14 Days',
          'hero.trustbar.time.sub': 'to go live',
          'hero.trustbar.roas': '4.2×',
          'hero.trustbar.roas.sub': 'avg. ROAS after 60 days',
          ...
          // Footer
          'footer.tagline': 'AI-Powered Lead Generation for Service Businesses.',
