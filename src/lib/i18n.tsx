...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'hero.industry2': 'Beratungsfirmen',
    'hero.industry3': 'Kanzleien & Steuerberater',
    'hero.industry4': 'Marketing-Agenturen',
    'hero.industry5': 'Coaching & Training',
    'hero.industry6': 'Immobilien',
    'hero.industry7': 'IT & Software',
  ...
  en: {
    ...
    'hero.industry2': 'Consulting Firms',
    'hero.industry3': 'Law Firms & Tax Advisors',
    'hero.industry4': 'Marketing Agencies',
    'hero.industry5': 'Coaching & Training',
    'hero.industry6': 'Real Estate',
    'hero.industry7': 'IT & Software',
