...
const HowItWorksSection = () => {
  ...
  return (
    <section id="how-it-works" className="py-24 md:py-36 border-t border-white/5">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-zinc-400 text-base md:text-lg leading-relaxed">{t('how.subtitle')}</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="glass-card p-7 rounded-xl"
            >
              <div className="text-4xl font-bold gradient-text-blue mb-5">{step.num}</div>
