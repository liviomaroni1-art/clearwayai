...
const HowItWorksSection = () => {
  ...
  return (
    <section id="how-it-works" className="py-24 md:py-36 border-t border-border">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed">{t('how.subtitle')}</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="text-5xl font-bold text-foreground/10 font-display mb-5">{step.num}</div>
