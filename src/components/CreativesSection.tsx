    ...
    return (
          <section className="py-20 bg-background">
                <div className="container mx-auto px-4">
                        ...
                        <div
                                        key={index}
                                        className="rounded-xl overflow-hidden border border-white/10 hover:border-primary/50 transition-all duration-300 hover:scale-105 shadow-lg"
                                      >
                                      <img
                                                        src={creative.url}
                                                        alt={creative.alt}
...
export default CreativesSection;</section>
