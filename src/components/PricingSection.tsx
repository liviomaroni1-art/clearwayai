        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 md:p-16">
          ...
          once: true
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full text-sm">
              ...
              <span className="text-slate-300">Live in 72 hours</span>
            </div>
          </motion.div>
          ...
          once: true
            ...
            <p className="text-xl text-slate-300 mb-2">Replaces $3,500+/month receptionists. Precision engineering.</p>
            <p className="text-emerald-400 font-medium">💰 Save at least 12,000/year compared to human staff and get more work</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            delay: 0.1
              ...
              <ul className="space-y-5 mb-8">
                {["Up to 2,000 minutes/month", "24/7 calls + auto appointment booking", "Call summaries (email/SMS) + CRM sync", "Google Calendar + 24h reminders", "Weekly reports + full setup"].map((feature, i) => <li key={i} className="flex items-start gap-4 text-slate-200">
              ...
              <div className="bg-black/30 p-6 rounded-2xl mb-6 text-center">
                ...
                <div className="text-slate-400">Done-for-you Retell.ai/n8n (36-48 hours)</div>
              </div>
              ...
              <Button onClick={() => bookDemo('signature')} className="w-full bg-gradient-to-r from-violet-500 to-violet-600 hover:from-violet-600 hover:to-violet-700 text-white py-6 text-lg font-bold rounded-2xl min-h-[56px]">
            ...
            delay: 0.2
              ...
              <ul className="space-y-5 mb-8">
                {["Everything in Signature", "Up to 3,000 minutes/month", "Custom voice + advanced routing", "Multi-service calendar sync", "Bi-weekly performance tuning"].map((feature, i) => <li key={i} className="flex items-start gap-4 text-slate-200">
                    <Check className="w-6 h-6 text-emerald-500 flex-shrink-0 mt-0.5" />
                    <span>{feature}</span>
                  </li>)}
              </ul>
              ...
              <Button onClick={() => bookDemo('elite')} className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white py-6 text-lg font-bold rounded-2xl min-h-[56px]">
          ...
          delay: 0.3
            ...
            <div className="inline-block bg-black/40 px-8 py-4 rounded-xl text-lg text-slate-300 mb-8">Custom quoted • 8,000 minutes included</div>
            <div>
              <Button onClick={() => bookDemo('enterprise')} className="bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-900 px-12 py-6 text-xl font-bold rounded-2xl">
          ...
          delay: 0.4
            ...
            <h3 className="text-2xl font-bold text-emerald-400 mb-6 text-center md:text-4xl">📉 36-Month Commitment = 20% OFF </h3>
            <div className="grid sm:grid-cols-3 gap-6">
              ...
              <div className="flex items-center">
                <div className="text-lg text-emerald-500 font-semibold">+ No setup fees</div>
              </div>
            </div>
          </motion.div>
          ...
          delay: 0.5
            ...
            <p className="text-lg text-pink-100/90 mb-8 max-w-2xl mx-auto">Unique workflows? Industry-specific logic? Crazy ideas? We build it. Scoped in  less than 72hrs.</p>
            <Button onClick={() => bookDemo('custom')} className="bg-white hover:bg-slate-100 text-pink-500 px-12 py-6 text-xl font-bold rounded-2xl">
