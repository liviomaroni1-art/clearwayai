...
const FounderSection = () => {
  return (
    <section id="about" className="section-calm bg-secondary/20">
          ...
          <div className="elevated-card p-8 md:p-12">
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              <div className="md:col-span-1 flex flex-col items-center gap-4">
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 border-2 border-primary/20 flex items-center justify-center">
                  <span className="text-4xl font-bold text-primary/40">G</span>
                </div>
              ...
              <div className="md:col-span-2 text-center md:text-left">
                ...
                {/* Founder quote - Humanized */}
                <blockquote className="text-lg text-muted-foreground mb-6 leading-relaxed border-l-4 border-primary/30 pl-4 italic">
