...
import { Shield, Lock, Eye, FileCheck, Globe, Server, ArrowRight, FileText } from "lucide-react";
...
const points = [
  ...
  "Call recordings optional and fully configurable.",
    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          {/* 2-column layout: text left, badges right */}
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Your patients' and clients' data deserves the same protection as a Fortune 500 company — even if you're a 3-person practice.
              </p>
